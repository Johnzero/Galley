    ...
    Q = function() {
        ...
        if (f.is(":visible") && false === d.onCleanup(l, p, d)) {
            ...
            if (d.titleShow !== false) {
                ...
                s = a;
                var link = d.orig[0].getAttribute('data-link');
                if (link) {
                    if ( s ) {
                        s = s + '<a href="'+link+'" id="fancybox-download" ><i class="icon-cloud-download"></i></a>';
                    } else {
                        s = '<a href="'+link+'" id="fancybox-download" ><i class="icon-cloud-download"></i></a>';
                    }
                }
