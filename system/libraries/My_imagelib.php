...
class MY_Image_lib
{
     ...
     * @return    bool
     */
    function watermark($dst_img = null)
    {
        if ($this->wm_type == 'overlay') {
            return $this->overlay_watermark($dst_img);
        } else {
            return $this->text_watermark($dst_img);
        }
    }
     ...
     * @return    bool
     */
    function overlay_watermark($dst_img = null)
    {
     ...
     * @return    bool
     */
    function text_watermark($dst_img = null)
    {
        if ($dst_img) {
            $src_img = $dst_img;
...
file_put_contents('./log.txt',$this->orig_width);
