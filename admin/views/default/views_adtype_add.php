...
<form action="<?php echo site_url("adtype/add");?>" method="post" class="definewidth m2"  name="myform" id="myform">
<input type="hidden" name="action" value="doadd">
<table class="table table-bordered table-hover m10">

    <tr>
        <td class="tableleft">类型(位置)名称</td>
        <td><input type="text" name="typename" id="typename" required="true" errMsg="请输入导航类型名称" tip="请输入导航类型名称"/></td>
    </tr>
